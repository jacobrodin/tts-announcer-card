 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function dt(t){return ct({...t,state:!0,attribute:!1})}let pt=class extends nt{constructor(){super(...arguments),this.message="",this.selectedSpeaker="media_player.bedroom_speaker"}async speak(){this.message.trim()&&(await this.hass.callService("tts","speak",{entity_id:"tts.home_assistant_cloud",media_player_entity_id:this.selectedSpeaker,message:this.message,cache:!1}),this.message="")}render(){return I`
      <ha-card header="TTS Announcer">
        <div class="container">

          <select
            .value=${this.selectedSpeaker}
            @change=${t=>this.selectedSpeaker=t.target.value}
          >
    ...
    `}getCardSize(){return 3}};pt.styles=((t,...e)=>{const s=1===t.length?t[0]:e.reduce((e,s,i)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[i+1],t[0]);return new o(s,t,i)})`
    ha-card {
      padding: 16px;
      border-radius: 20px;
    }
  ...
  `,t([ct({attribute:!1})],pt.prototype,"hass",void 0),t([dt()],pt.prototype,"message",void 0),t([dt()],pt.prototype,"selectedSpeaker",void 0),pt=t([(t=>(e,s)=>{void 0!==s?s.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})("tts-announcer-card")],pt);export{pt as TTSAnnouncerCard};
